...
function rowForVersion (site, page, version, options, index) {
  const row = [
    ...
    page.url,
    page.versionistaUrl,
    version.diffWithPreviousUrl || '[initial version]',
    version.diffWithFirstUrl || '[initial version]',
    formatDate(version.diffWithPreviousDate) || '[initial version]',
    formatDate(version.diffWithFirstDate) || '[initial version]',
